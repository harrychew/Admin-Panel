                                ...
                                <div class="module-option clearfix">
                                    <div class="pull-left">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="https://www.gmail.com/ ">Inbox</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="pull-right">
                                        <a href="compose_email.php" class="btn btn-primary">Compose</a>
                                    </div>
                                    ...
                                    <table class="table table-message">
                                        <tbody>
                                            ...
                                            <tr class="unread">
                                                ...
                                                <td>
                                                    <a href="delete_email?delete_email=<?php echo $email_id?>">
                                                        Delete
                                                    </a>
                                                </td>
                                            </tr>
