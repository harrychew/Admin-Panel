...
if(!isset($_SESSION['admin_id'])){
	...
	if(isset($_GET['delete_shopping_request'])){
		$delete_id=$_GET['delete_shopping_request'];
		$delete_shopping="delete from shopping_request where Shopping_request_id='$delete_id'";
		$run_delete =mysqli_query($con,$delete_shopping);
		if($run_delete){
			echo "<script>alert('A Shopping Request has been deleted!')</script>";
