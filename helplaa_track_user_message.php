					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Track User Message</h3>
							
							</div>
							<div class="module-body">    
							<a href="test_message.php">Insert post to test link</a>
							...
							<table id ="act">
                              ...
                              <tbody>
						        	...
						        	include("includes/db.php");
									 ...
									 $run_mess=mysqli_query($con,$get_mess);
									 while($row_mess=mysqli_fetch_array($run_mess)){

									 $Message_id =$row_mess['Message_id'];
									 $Message=$row_mess['Message'];
									 $Sender_id=$row_mess['Sender_id'];
									 $Receiver_id = $row_mess['Receiver_id'];
									 $Timestamp = $row_mess['Timestamp'];
									 $Shopping_request_id =$row_mess['Shopping_request_id'];
									 $Help_post_id =$row_mess['Help_post_id'];
									 $Food_request_id =$row_mess['Food_request_id'];
									?>
