...
if(!isset($_SESSION['admin_id'])){
	...
	if(isset($_GET['edit_food_status'])){
	$get_id= $_GET['edit_food_status'];
	$get_food = "select * from food_request where Food_request_id='$get_id'";
...
<?php
	...
	$update_id=$Food_request_id;
	$new_status=$_POST['status'];

	$update_status= "update food_request set status='$new_status' where Food_request_id='$update_id'";
	$run_update= mysqli_query($con,$update_status);
	if($run_update){
		echo "<script>alert('Food request status has been updated!')</script>";
