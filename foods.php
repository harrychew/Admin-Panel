                            ...
                            <!-- <table cellpadding="0" cellspacing="0" border="0" class="act table table-bordered table-striped   display"> -->
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="edit_food.php?edit_food=<?php echo $Food_id;?>">Edit</a></td>
                                        <td><a href="delete_food.php?delete_food=<?php echo $Food_id;?>">Delete</a></td>
