...
if(!isset($_SESSION['admin_id'])){
	...
	if(isset($_GET['edit_shop'])){
		...
		$get_id=$_GET['edit_shop'];
		global $con;
		$get_shop="select * from shops where Shop_id='$get_id'";
							...
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" method="post" enctype="multipart/form-data">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="shop_name" size="60" value="<?php echo $Shop_name; ?>"/>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Shop Address</label>
											<div class="controls">
                                                <textarea name="shop_address" cols="20" rows="10" value=""/><?php echo $Shop_address; ?></textarea>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Shop City</label>
											<div class="controls">
										...
										<div class="control-group">
											<div class="controls">
												<input type="submit" name="update_shop" value="Update Shop"/>
											</div>
										</div>
									</form>
							</div>
...
<?php
	if(isset($_POST['update_shop'])){
		...
		$update_shop= "update shops set Shop_name='$shop_name', Shop_address='$shop_address', City='$city',
		 Latitude='$latitude', Longitude='$longitude'
		where Shop_id='$update_id'";
		
		$run_update=mysqli_query($con,$update_shop);
		if($run_update){
