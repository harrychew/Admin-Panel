							...
							<table id="act">
                                ...
                                <tbody>
						        	...
						        	include("includes/db.php");
									 ...
									 $Requester_id=$row_shop['Requester_id'];
									 $Transporter_id=$row_shop['Transporter_id'];
									 $Date_time_stamp=$row_shop['Date_time_stamp'];
									 $Total_product_amount = $row_shop['Total_product_amount'];
									 $Delivery_time =$row_shop['Delivery_time'];
									 $Collector_id = $row_shop['Collector_id'];
									 $Shop_id =$row_shop['Shop_id'];
									 $Distance = $row_shop['Distance'];
									 $Transport_charge=$row_shop['Transport_charge'];
									 $latitude=$row_shop['latitude'];
									 $longitude=$row_shop['longitude'];
									 $service_charge=$row_shop['service_charge'];
									 $Status=$row_shop['Status'];	
									...
									?>
						                ...
						                <tr>
						         			...
						         			<td><?php echo $Requester_id; ?></td>
						          			...
						          			<td><?php echo $Total_product_amount; ?></td>
						          			...
						          			<td>
						          				<a href="edit_shop_status.php?edit_shop_status=<?php echo $Shopping_request_id; ?>" style="text-decoration: none">Update Status
						          				</a>
						          			</td>
						          			<td>
						          				<a href="delete_shopping_request.php?delete_shopping_request=<?php echo $Shopping_request_id; ?>" style="text-decoration: none">Delete
						          				</a>
						          			</td>				          	
						        		</tr>
                            ...
                            <table id="act2">
                                ...
                                <tbody>
                                    ...
                                    include("includes/db.php");
                                     ...
                                     $Shopping_request_id =$row_items['Shopping_request_id'];
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit_shopping_item.php?edit_shopping_item=<?php echo $Item_id; ?>" style="text-decoration: none">Update item
                                                </a>
                                            </td>
                                            <td>
                                                <a href="delete_shopping_item.php?delete_shopping_item=<?php echo $Item_id; ?>" style="text-decoration: none">Delete
                                                </a>
                                            </td>                           
                                        </tr>
