...
if(!isset($_SESSION['admin_id'])){
	...
	$Help_post_id= $_GET['edit_status'];
	$get_help = "select * from help_posts where Help_post_id='$Help_post_id'";
	$run_help = mysqli_query($con,$get_help);
	$row_help= mysqli_fetch_array($run_help);
							...
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" method="post" enctype="multipart/form-data">
										<div class="control-group">
											<h2>Help Post ID:<?php echo $Help_post_id?></h2>
											<label class="control-label" for="basicinput">Update Status</label>
											<div class="controls">
												<select name="status">
...
<?php
	...
	$update_id=$Help_post_id;
	$new_status=$_POST['status'];
	$update_stat= "update help_posts set status='$new_status' where Help_post_id='$update_id'";
	$run_stat= mysqli_query($con,$update_stat);
	if($run_stat){
		echo "<script>alert('A status has been updated!')</script>";
