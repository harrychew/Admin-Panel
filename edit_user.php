...
if(!isset($_SESSION['admin_id'])){
	...
	if(isset($_GET['edit_user'])){
		...
		$Latitude = $row_user['Latitude'];
		$Longitude = $row_user['Longitude'];
		$Active =$row_user['Active'];
		$Password = $row_user['Password'];
		$Gcm_reg_id =$row_user['Gcm_reg_id'];
							...
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" method="post" enctype="multipart/form-data">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="user_name" size="60" value="<?php echo $Name; ?>"/>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">User Password</label>
											<div class="controls">
												<input type="text" name="user_pass" size="60" value="<?php echo $Password; ?>"/>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">User Email</label>
											<div class="controls">
												<input type="text" name="user_email" size="60" value="<?php echo $Email; ?>"/>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">User Phone</label>
											<div class="controls">
												<input type="text" name="user_phone" size="60" value="<?php echo $Phone; ?>"/>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">User Image</label>
											<div class="controls">
												<input type="file" name="user_image"/><img src="users/photo/<?php echo $photo;?>" width="60" height="60" />
											</div>
										</div>
										<div class="control-group">
...
<?php
	if(isset($_POST['update_user'])){
		...
		move_uploaded_file($user_image_tmp,"users/photo/$user_image");
		
		$update_user= "update users set Name='$user_name',Email='$user_email',Phone='$user_phone',
		Password='$user_pass',photo='$user_image', Latitude='$latitude', Longitude='$longitude'
