...
if(!isset($_SESSION['admin_id'])){
	...
	if(isset($_GET['edit_restaurant'])){
		...
		global $con;
		$get_rest="select * from restaurants where Restaurant_id='$get_id'";
		$run_rest=mysqli_query($con,$get_rest);
		$row_rest=mysqli_fetch_array($run_rest);
		$Restaurant_id =$row_rest['Restaurant_id'];
        $Restaurant_name =$row_rest['Restaurant_name'];
        $Restaurant_address =$row_rest['Restaurant_address'];
        $City =$row_rest['City'];
        $Latitude =$row_rest['Latitude'];
        $Longitude =$row_rest['Longitude'];
							...
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" method="post" enctype="multipart/form-data">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="restaurant_name" size="60" value="<?php echo $Restaurant_name; ?>"/>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Restaurant Address</label>
											<div class="controls">
                                                <textarea name="restaurant_address" cols="20" rows="10" value=""/><?php echo $Restaurant_address; ?></textarea>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Restauarant City</label>
											<div class="controls">
												<input type="text" name="city" size="60" value="<?php echo $City; ?>"/>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="latitude" size="60" value="<?php echo $Latitude; ?>"/>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Longitude</label>
											<div class="controls">
												<input type="text" name="longitude" size="60" value="<?php echo $Longitude; ?>"/>
											</div>
										</div>
										...
										<div class="control-group">
											<div class="controls">
												<input type="submit" name="update_rest" value="Update Restaurant"/>
											</div>
										</div>
									</form>
							</div>
...
<?php
	if(isset($_POST['update_rest'])){
		...
		$update_rest= "update restaurants set Restaurant_name='$restaurant_name', Restaurant_address='$restaurant_address', City='$city',
		 Latitude='$latitude', Longitude='$longitude'
		where Restaurant_id='$update_id'";
		
		$run_update=mysqli_query($con,$update_rest);
		if($run_update){
			echo "<script>alert('Restauarant has been updated!')</script>";
