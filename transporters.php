							...
							<table id="act">
                                ...
                                <tbody>	
						        	...
						        	include("includes/db.php");
									 ...
									 $User_id =$row_transporter['User_id'];
									...
									<tr align="center">
										...
										<td><img src="users/photo/<?php echo $Photo;?>"height="60" width="60"/></td>
										<td><a href="edit_user.php?edit_user=<?php echo $User_id;?>">Edit</a></td>
										<td><a href="delete_transporter.php?delete_transporter=<?php echo $Transporter_id;?>">Delete</a></td>
