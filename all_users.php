                        ...
                        <div class="module">
                            ...
                            <div class="module-option clearfix">
                                ...
                                <div class="input-append pull-left">
                                   <!--  <input type="text" class="span3" onkeyup="searchFunction()" placeholder="Filter by name...">
                                   -->
                                </div>
                                </form>
                                    ...
                                    <div class="span6">
                                        <div class="media user">
                                            <a class="media-avatar pull-left" href="#">
                                                <img src="users/photo/<?php echo $user_image;?>"/>
                                            </a>
                                            <div class="media-body">
                                                ...
                                                <div class="media-option btn-group shaded-icon">
                                                    <small class="muted"><?php echo $Email; ?></small></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
