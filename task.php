								...
								<table class="table table-message">
									...
									<tbody>
										...
										<?php
										 	$get_task="select * from tasks";
   											$run_task=mysqli_query($con,$get_task);
   											while($row_task=mysqli_fetch_array($run_task)){
										...
										<tr class="task">
											...
											<td class="cell-title"><div><?php echo $task_detail; ?></div></td>
											<td class="cell-status hidden-phone hidden-tablet"><b class="due"><?php echo $status; ?></td>
											<td class="cell-time align-right"><?php echo $due_date;?></td>
											<td class="cell-time align-right">
												<a href="edit_task_status.php?edit_task_status=<?php echo $task_id; ?>">Update</a>
												<a href="delete_task.php?delete_task=<?php echo $task_id;?>">Delete</a>
											</td>
										</tr>
