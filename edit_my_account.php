...
if(!isset($_SESSION['admin_id'])){
    echo "<script>window.open('login.php?not_admin=You are not an Admin','_self')
		...
		global $con;
		$get_admin="select * from admins where admin_id='$get_id'";
		$run_admin=mysqli_query($con,$get_admin);
		$row_admin=mysqli_fetch_array($run_admin);

		$Admin_id =$row_admin['admin_id'];
		$user_email = $row_admin['user_email'];
		$user_pass =$row_admin['user_pass'];
		$Name= $row_admin['Name'];
							...
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" method="post" enctype="multipart/form-data">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="admin_email" size="60" value="<?php echo $user_email; ?>"/>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Password</label>
											<div class="controls">
												<input type="password" name="admin_pass" size="60" value="<?php echo $user_pass; ?>"/>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Name</label>
											<div class="controls">
												<input type="text" name="admin_name" size="60" value="<?php echo $Name; ?>"/>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Phone</label>
											<div class="controls">
												<input type="text" name="admin_phone" size="60" value="<?php echo $Phone; ?>"/>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Photo</label>
											<div class="controls">
												<input type="file" name="admin_photo"/><img src="admins/Photo/<?php echo $Photo;?>" width="60" height="60" />
											</div>
										</div>
...
<?php
	if(isset($_POST['update_admin'])){
		...
		move_uploaded_file($admin_photo_tmp,"admins/photo/$admin_photo");
		
		$update_admin= "update admins set user_email='$admin_email',user_pass='$admin_pass', Name='$admin_name',
		Phone='$admin_phone', Photo='$admin_photo' where admin_id='$update_id'";
