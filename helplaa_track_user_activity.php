					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Track User Activity</h3>
							
							</div>
							<div class="module-body">
							<a href="test_help_post.php">Insert post to test link</a>
							...
							<table id="act">
                              ...
                              <tbody>
						        	...
						        	include("includes/db.php");
									 ...
									 $Helper_id=$row_help['Helper_id'];
									 $User_id=$row_help['User_id'];
									 $Date_time_stamp = $row_help['Date_time_stamp'];
									 $Post_title = $row_help['Post_title'];
									 $Post_description =$row_help['Post_description'];
									 $Reward = $row_help['Reward'];
									 $Latitude =$row_help['Latitude'];
									 $Longitude = $row_help['Longitude'];
									 $Address=$row_help['Address'];
									 $Status=$row_help['status'];	

									?>
						          
						                <tr>
						         			<td><?php echo $Help_post_id; ?></td>
						         			<td><?php echo $Date_time_stamp; ?></td>
						          			<td><?php echo $User_id." requested for help, ".$Helper_id." responded"; ?></td>
						          			...
						          			<td><a href="edit_status.php?edit_status=<?php echo $Help_post_id; ?>" style="text-decoration: none">Update Status</a></td>				          	
						        		</tr>
