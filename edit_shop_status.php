...
if(!isset($_SESSION['admin_id'])){
	...
	if(isset($_GET['edit_shop_status'])){
	$get_id= $_GET['edit_shop_status'];
	$get_shop = "select * from shopping_request where Shopping_request_id='$get_id'";
									...
									<form class="form-horizontal row-fluid" method="post" enctype="multipart/form-data">
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<p><?php echo $Shopping_request_id;?></p>
...
<?php
	...
	$update_id=$Shopping_request_id;
	$new_status=$_POST['status'];

	$update_status= "update shopping_request set status='$new_status' where Shopping_request_id='$update_id'";
	$run_update= mysqli_query($con,$update_status);
	if($run_update){
		echo "<script>alert('Shopping request status has been updated!')</script>";
